...
const APPROVED = {
  ...
  added: [
    ...
    // 4.2 Meta line (DRAFT wording: the REVIEW 5812593257 proposal, adopted per Dustin's APPROVED and Ben's instruction #2143; supersedes the shorter #2123 LEGAL-READ 5810656623 line)
    '<li><strong>Meta (Facebook and Instagram):</strong> Advertising measurement (the Meta Pixel in your browser and, when you purchase a measurement report, a purchase event sent from our servers that includes a hashed copy of your email address), and hosting the lead forms that appear in our ads (see Section 2.3)</li>',
    // 5.4 Clarity paragraph: the signed-in sentence (#1939 5810533784) with its second sentence replaced by the REVIEW 5812593257 proposal (recorded page addresses)
    '<p>We use Microsoft Clarity to understand how visitors interact with our platform, including page navigation, scrolling behavior, and click patterns. Clarity may set cookies on your device and may record a replay of your on-page interactions to help us identify usability issues and improve the platform. This includes pages you view while signed in to your account, such as your dashboard and your bids. On those pages we set Clarity to mask the page content and everything you type, so the text on the page and anything you enter are not visible in any replay. Clarity does record the address of each page you visit; on some pages that address contains an internal reference number for your project, which does not by itself show your name or contact details. For more information, see Microsoft\'s Privacy Statement at <a href="https://privacy.microsoft.com/privacystatement" target="_blank" rel="noopener">https://privacy.microsoft.com/privacystatement</a>.</p>',
