...
// This is the COPY. The canonical file is supabase/functions/
// send-homeowner-next-steps/optout-token.ts. This repo's Edge Function deploy path does not resolve
