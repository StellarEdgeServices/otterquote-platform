...
function generateComplianceAddendumPdf(contractorName, homeownerName, contractDate) {
  ...
  y -= 20;
  y = addWrappedText(50, y, 10, "F1", `OtterQuote is a technology platform that facilitates connections between homeowners and contractors. OtterQuote is NOT a party to this contract and assumes no liability for work performed under this agreement. This contract is between the homeowner and the contractor named above.`, 512);
  y -= 10;
...
function generateRetailScopeOfWorkPdf(params) {
  ...
  addText(160, y, 10, "F1", claimId.slice(0, 8).toUpperCase());
  y -= 20;
  hLine(y);
  y -= 16;
  ...
  addText(LEFT_X, y, 8, "F1", `Generated by Otter Quotes on ${contractDate} - Job Ref ${claimId.slice(0, 8).toUpperCase()}`);
