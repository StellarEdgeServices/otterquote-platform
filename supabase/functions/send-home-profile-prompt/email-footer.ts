...
// send-partner-onboarding and send-partner-status-email each carry their
// own byte-identical copy of this file rather than importing one shared
// module.
//
// Value: the resolved D-237 answer (comment 5583808162, 2026-09-08 on
// #1824), reused here for the D-231 post-completion home-profile prompt --
// a homeowner-facing commercial nudge, not a purely transactional message,
// so the physical postal address is required. Reusing an already-answered
 ...
 * send-homeowner-next-steps/email-footer.ts's POSTAL_ADDRESS. */
