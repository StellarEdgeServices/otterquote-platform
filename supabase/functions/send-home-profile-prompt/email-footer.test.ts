...
// this function.
// Run: deno test supabase/functions/send-home-profile-prompt/email-footer.test.ts
//
...
Deno.test("gh-1824 send-home-profile-prompt POSTAL_ADDRESS is byte-identical to send-homeowner-next-steps' D-237 constant", () => {
