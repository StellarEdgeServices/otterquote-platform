-- Rollback for: 20260818214635_gh973_register_partner_rate_limit_gate.sql
-- GitHub: #973
-- WARNING: restores the PRE-FIX behavior - no rate-limit gate on
-- register_partner, i.e. reopens the unbounded-registration abuse vector.
...
DELETE FROM public.rate_limit_config WHERE function_name = 'register_partner';
