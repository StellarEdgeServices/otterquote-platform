-- Rollback for 20260924210000_gh2154_p5_meta_lead_id.sql
--
-- Order matters: drop the 21-arg register_partner FIRST, recreate the
-- pre-migration 20-arg definition (byte-identical to
-- 20260924160000_gh2154_p2_partner_attribution_activation.sql) SECOND,
-- remove the rate_limit_config row THIRD, and only THEN drop meta_lead_id
-- — dropping the column first would break the 21-arg function body while
-- it still references it.
