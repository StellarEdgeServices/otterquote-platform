-- Migration: v110_drop_referrals_advance_status_policy
...
-- (yeszghaspzwwstvsrioa) 2026-08-14T01:46:40Z, recorded in
-- supabase_migrations.schema_migrations as version 20260814014640, name
-- "v110_drop_referrals_advance_status_policy". NEVER RE-RUN.
--
