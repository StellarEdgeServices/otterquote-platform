-- Migration: add_claims_hover_measurements
...
-- (yeszghaspzwwstvsrioa) 2026-07-09T10:02:51Z, recorded in
-- supabase_migrations.schema_migrations as version 20260709100251, name
-- "add_claims_hover_measurements". NEVER RE-RUN.
--
