-- Migration: wc-cert-reminder-30-sent-at
...
-- (yeszghaspzwwstvsrioa) 2026-05-06T10:57:18Z, recorded in
-- supabase_migrations.schema_migrations as version 20260506105718, name
-- "wc-cert-reminder-30-sent-at". NEVER RE-RUN.
--
...
ALTER TABLE contractors ADD COLUMN IF NOT EXISTS wc_cert_reminder_30_sent_at TIMESTAMPTZ;
